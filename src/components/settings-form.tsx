...
export function SettingsForm() {
  ...
  return (
    <div className="max-w-[520px]">
      <h2 className="text-[20px] font-semibold text-primary mb-1">Pengaturan Profil</h2>
      <p className="text-[14px] text-secondary mb-6">Perbarui informasi akunmu.</p>
      ...
      {message && (
        <div className="mb-4 text-[13px] bg-neon/10 border border-neon/40 text-neon rounded-lg px-3 py-2.5">
          {message}
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="card-dark p-6 flex flex-col gap-4">
        <div>
          <label className="block label-caps text-secondary mb-1.5">Nama Lengkap</label>
          <input
            type="text"
            required
        ...
        <div>
          <label className="block label-caps text-secondary mb-1.5">
            Email <span className="normal-case text-[10px]">(tidak bisa diubah)</span>
          </label>
          <input
            type="email"
            disabled
        ...
        <div>
          <label className="block label-caps text-secondary mb-1.5">Institusi</label>
          <input
            type="text"
            className="input-dark"
